...
urlpatterns = [
    ...
    path('product/<slug:product_slug>/', views.product_detail_view, name='store_product_detail'),
    ...
    path('order/invoice/<int:order_id>/', views.order_invoice_view, name='order_invoice'),
